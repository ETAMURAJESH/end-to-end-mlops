...
def log_run(
    model_name: str, model, params: dict,
    metrics: dict, cv_metrics: dict,
    X_train, y_pred, dataset_version: str,
) -> None:
...
def run_pipeline() -> None:
    ...
    for model_name, model in models.items():
        ...
        log_run(model_name, model, params, metrics, cv_metrics, X_train, y_pred, dataset_version)
        results[model_name] = {
            "model":      model,
            "metrics":    metrics,
